...
import { useAddProduct } from "./state";
...
export const AddProduct = () => {
  ...
  const { formData, handleSave, setFormValue } = useAddProduct({
    ...
    <div className="flex justify-center items-center h-full">
      ...
      >
        <h2 className="text-xl font-bold py-4 mb-4">
          ...
          {isUpdate ? appMessages.product.updateTitle :
          appMessages.product.registerTitle }
        </h2>
