    ...
    <div className="relative w-full h-screen">
      ...
      <div className="flex justify-center items-center h-full">
        <form
          ...
          action=""
        >
          <h2 className="text-xl font-bold py-4 mb-4">Registar Lojas</h2>
          ...
          <div className="flex flex-col mb-4">
            <label className="text-black font-medium text-sm ">Localização</label>
            <input
              className="border relative bg-gray-100 p-2 rounded-sm focus:outline-indigo-600"
              type="text"
            />
          ...
          <div className="flex flex-col mb-4">
            <label className="text-black font-medium text-sm ">Nº Telefone</label>
            <input
              className="border relative bg-gray-100 p-2 rounded-sm focus:outline-indigo-600"
              type="text"
            />
